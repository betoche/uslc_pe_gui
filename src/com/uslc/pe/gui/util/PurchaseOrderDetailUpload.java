...
public class PurchaseOrderDetailUpload {
	...
	public PurchaseOrderDetailUpload(String upcCode, String deptNumber,
			String itemCode, String poNumber, String colorName,
			String colorNumber, String size, int items,
			int itemsPerCarton) {
