...
import com.uslc.pe.gui.master.interfaces.SystemCommonMethods;
...
public class Client extends SystemCommons implements SystemCommonMethods {
	private com.uslc.pe.gui.logic.ClientLogic client = null;
	...
	public LiveDataAccessLifeCicle getLiveDataAccessLifeCicle() {
		if( client == null ) {
			client = new com.uslc.pe.gui.logic.ClientLogic(this, getUser());
		}
		return client;
	}
